      ...
      <div className='h-full'>
        <Layout className='h-full bg-transparent flex flex-col md:flex-row'>
            ...
            <Layout.Sider
              ...
              ${
                isMobile
                  ...
                  : 'relative z-[1] w-80 h-[calc(100dvh-var(--app-header-height))]'
              }
            `}
          ...
          <Layout.Content className='relative flex-1 overflow-hidden'>
            <div className='flex max-h-[calc(100dvh-var(--app-header-height))] flex-col overflow-hidden lg:flex-row lg:h-[calc(100dvh-var(--app-header-height))]'>
