...
func InitOptionMap() {
	...
	common.OptionMap["DisallowUnsetRatioModelEnabled"] = strconv.FormatBool(operation_setting.DisallowUnsetRatioModelEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "DisallowUnsetRatioModelEnabled":
			operation_setting.DisallowUnsetRatioModelEnabled = boolValue
